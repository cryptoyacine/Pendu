...
public class choix_motp2 {
	 ...
	 */
			...
			public void run() {
				try {
					choix_motp2 window = new choix_motp2();
	...
	private void initialize() {
		...
		JLabel lblchoix1 = new JLabel("Joueur 2 : Entrer le mot \u00E0 faire deviner");
		...
		btnValidermot.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(mot1.equals("")) {
					...
					models.setMot_p2(mot1);
					
					essai_p1 g=new essai_p1();
					g.run();
