...
public class essai_p2 {
 private String[] mots;
	...
	private void initialize() {
		...
		choix_motp1 mot = new choix_motp1();
		a = choix_motp1.lemot();
		
		choix_motp2 jnom2 = new choix_motp2();
		b = choix_motp2.lemot();
		...
		lblessai.setBounds(231, 298, 349, 29);
		...
		comboBox.setBounds(564, 219, 168, 88);
